...
public class EncryptionService {
  ...
  private static String _SALT = "EqdmPh53c9x33EygXpTpcoJvc4VXLK";
  ...
  public static byte[] hash(char[] password, byte[] salt) {
    PBEKeySpec spec = new PBEKeySpec(password, salt, _ITERATIONS, _KEY_LENGTH);
  ...
  public static String generateSecurePassword(String password) {
    ...
    byte[] securePassword = hash(password.toCharArray(), _SALT.getBytes());
